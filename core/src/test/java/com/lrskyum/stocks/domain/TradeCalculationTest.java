 ...
 *
 */
public class TradeCalculationTest {
    ...
    public void testCalc() throws Exception {
        ...
        List<TradeSignal> tradeSignals = new MovingAvgTradeSignalsCalculation(fastTs, slowTs).getTradeSignals();
        System.out.println(tradeSignals);
